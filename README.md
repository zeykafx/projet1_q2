...
Lien vers le cours inginious: https://inginious.info.ucl.ac.be/course/P1_2A_3

# Modifications apportée suites au reviews :
...
/n• Il a été décidé d’approfondir  l'utilisation de l'hérédité en limitant la classe vehicule à un seul attribut au lieu de deux. Il faut désormais définir l'attribut color depuis la classe camion.

/n• L'utilisation de l'index a été délaissée au profit de la valeur de l'attribut

/n• Révisons des tests
